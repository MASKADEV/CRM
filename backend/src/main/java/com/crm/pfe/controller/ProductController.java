...
import com.crm.pfe.payload.request.ProductRequest;
import com.crm.pfe.service.ProductService;
    ...
    public ResponseEntity<Void> addImagesToProduct(
        ...
        try {
            ...
            Set<ProductImage> productImages = images.stream().map(image -> {
                ...
                try {
                    productImage.setPath(image.getBytes().toString()); // assuming you have a method to convert MultipartFile to bytes
                } catch (IOException e) {
